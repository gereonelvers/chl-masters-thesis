...
public class SpawnTouchZone : MonoBehaviourPunCallbacks
{
    ...
    [Tooltip("TextMeshPro component that displays spawn zone feedback.")]
    ...
    private void SpawnObject()
    {
        ...
        {
            Debug.LogWarning("SpawnTouchZone: No object has been selected to spawn!");
        }
    }
