...
// using UnityEngine.UI; // No longer needed if exclusively using TMP
...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class CountdownTimer : MonoBehaviourPunCallbacks
    {
        ...
        [Header("Reference to a TextMeshProUGUI component for visualizing the countdown")]
        public TextMeshProUGUI Text; // Changed from Text to TextMeshProUGUI
